...
{
    public class WebResourceRepository : RepositoryBase, IWebResourceRepository
    {
        public WebResourceRepository(IConnectionService connectionService) : base(connectionService)
        {
        }
